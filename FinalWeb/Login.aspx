...
<script type="text/javascript">
    ...
    <div>
		...
		<div class="row-fluid">
            ...
            <asp:TextBox ID="txtUsername"  class="input-large span10" runat="server" placeholder="Username"></asp:TextBox>
                            </div>
			...
			<asp:TextBox ID="txtPassword"  class="input-large span10" runat="server" placeholder="Password" TextMode="Password"></asp:TextBox>				
                            </div>
							<div class="clearfix"></div>
                ...
                <asp:Button ID="btnRegister" runat="server" Text="Register" class="btn btn-primary" 
